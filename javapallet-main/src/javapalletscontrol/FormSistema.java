    ...
    private void initComponents() {
     ...
     void mostraPilha(Stack<Produto> pilha, JTextArea meuList){
        ...
        if(minhaPilha.isEmpty())
            lblTopo.setText("Tpo:Vazio");
        else 
            lblTopo.setText("Topo: "+minhaPilha.peek());
     }// fim funcao
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        while(!minhaPilha.isEmpty()){
          ...
          if(p.getDescricao().equals(txtProduto.getText())){
              ...
              p = minhaPilha.pop();
              JOptionPane.showMessageDialog(rootPane, "Tudo removido"); 
              mostraPilha(minhaPilha, listPilha);
              txtProduto.setText("");
              txtQtd.setText("");
              }
                  ...
                  minhaPilha.push(p);
                  mostraPilha(minhaPilha, listPilha);
                  JOptionPane.showMessageDialog(null, "Retirado "+txtQtd.getText()+" do "+p.getDescricao());
                  txtProduto.setText("");
                  txtQtd.setText("");
              }
        ...
        while(!pilhaAuxiliar.isEmpty()){
          JOptionPane.showMessageDialog(null, "Movendo para pilha principal");  
